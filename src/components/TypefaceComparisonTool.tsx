...
const SpecimenOneLiner = (props: SpecimenOneLinerProps) => {
    ...
    return <div className="SpecimenOneLiner" style={style}>
        ...
        <div className="SpecimenOneLinerContent">
            ...
            <span className="SpecimenOneLinerFontName">{props.font.fontFamily}</span>
        </div>
    </div>;
};
...
` ;
    ...
    return <div className="specimenCard" style={{ fontFamily: props.font.fontFamily }}>
        <div className="specimenCardFontName">{props.font.fontFamily}</div>
...
const OneLinerSpecimen = ({ fonts, specimen, fontSize, fontWeight, fontsListChanged }: OneLinerSpecimenProps) => {
        ...
        >
            {fonts.filter(x => x.enabled).map((font, fontIndex) =>
                <ReactSmoothDndDraggable key={fontIndex}>
                    <SpecimenOneLiner key={fontIndex} specimen={specimen} font={font} fontSize={fontSize} fontWeight={fontWeight} />
...
export const TypefaceComparisonTool = () => {
    ...
    return <div>
        ...
        {showOneLiners && showRehearsalMarks && <div className="SpecimenOneLinerContainer">
            {fonts.filter(x => x.enabled).map((font, fontIndex) => <SpecimenOneLinerRehearsalMarks key={fontIndex} font={font} fontSize={fontSize} fontWeight={fontWeight} />)}
        </div>}
